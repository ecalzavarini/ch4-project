...
unset log
p [TIME_OFF:TIME_END] 'velocity_averages.dat' u 1:(d2($1,log($7)) / (-2.0*((2.*pi)/SY)**2.)  ) w l , nu , a



print "tau_real, nu_LB , nu_TH , 100.*(nu-a)/nu , time_dt , tau_u , NY , SY "
print  tau_real," ", a," ",nu," ",100.*(a-nu)/nu," ",time_dt," ",tau_u," ",NY," ",SY 
