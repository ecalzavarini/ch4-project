...
#define LB_FLUID_POROSITY /* the default is Darcy */
#define LB_FLUID_POROSITY_FORCHEIMER
//#define LB_FLUID_INCOMPRESSIBLE
...
#define LAGRANGE_BC_INELASTIC_REINJECT_VELOCITY_STOKES_HALF
