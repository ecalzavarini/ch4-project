...
# first we pad with 0 , because our signal is not periodic                    
    ...
    for k in xrange(0,len(acorr_x)):
        print(k/(10.*length),acorr_x[k]/n,acorr_y[k]/n,acorr_z[k]/n,acorr_t[k]/n,file=fout)
    fout.close()
    ...
    for k in xrange(0,len(real_acorr_x)/2):
        print(k*10., real_acorr_x[k]/real_acorr_x[0], real_acorr_y[k]/real_acorr_y[0], real_acorr_z[k]/real_acorr_z[0],real_acorr_t[k]/real_acorr_t[0], file=fout)
    fout.close()
